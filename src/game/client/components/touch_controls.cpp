...
//ForgottenCat Gonna Do Sonething Unique!
	...
	if(LabelData.m_Type != CButtonLabel::EType::ICON && *LabelData.m_pLabel=='%' && LabelData.m_Type != CButtonLabel::EType::RAINBOW && !CTouchControls::m_AllRainbow)
	{
	...
	if(LabelData.m_Type == CButtonLabel::EType::RAINBOW || CTouchControls::m_AllRainbow)
	{
		if(!fknano)
		{
